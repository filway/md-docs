  ...
  <div id="containerColor" :class="[pageClasses, themeMode]">
    ...
    <div class="theme-select">
      <ul>
        ...
        <li @click="modeSelect('theme themeDark')" :class="themeMode !== 'theme' ? 'active' : ''">
          🌑
        </li>
      </ul>
    </div>
  ...
  data() {
    return {
      ...
      cardConfig: {
        ...
        skill: ['🎸 吉他', '🖋️ 练字', '🍵 喝茶'],
        synopsis:
          '请你一定不要停不下来，成为你想成为的人，我知道你最近很累，是那种看不见的，面对未来那种无力感，但请你一定不要停下来，因为你的人生不可能就止于此了，再坚持一下，一切都会慢慢好起来的。',
      },
    }
  },
  methods: {
    modeSelect(mode) {
      if (!!mode) {
        ...
        document
          .querySelector('html')
          .style.setProperty('background-color', this.themeMode === 'theme' ? '#fff' : '#0d1117')
      }
    },
  },
  setup() {
...
.content-bg h1 p {
  ...
  white-space: nowrap;
  overflow: hidden;
  animation: typing 5s steps(12, end), /*英文速度*/ blink-caret 0.5s step-end infinite alternate;
}
.content-bg {
  width: 100%;
  height: 450px;
